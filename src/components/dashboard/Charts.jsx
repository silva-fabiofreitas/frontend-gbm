...
import { getPieCharts, getHistogramCharts } from '@/service/dashboard'
        ...
        <>
            <div className=" flex flex-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 grow">
                    <div className="shadow-md rounded-md border-stone-400 border-[1px]">
                    ...
                    <div className="col-span-full lg:col-span-4 shadow-md rounded-md border-stone-400 border-[1px]">
                        <Barchart data={dataAge}></Barchart>
                    </div>
                    <div className="col-span-full lg:col-span-2 shadow-md rounded-md border-stone-400 border-[1px] ">
